      ...
      messages: [
        {
          ...
          content: [
            ...
            'Generate topics strictly from official scheme-of-work style sources for the requested subject, class, and term.',
            'Do not invent topics outside the scheme of work.',
