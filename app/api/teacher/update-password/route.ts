// =============================
// /api/teacher/update-password/route.ts
// =============================
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data: teacherData, error: checkError } = await supabase
      .from("teachers")
    ...
    const expirationTime = new Date(teacherData.activation_expires_at);
    ...
    // Update the user's password in Auth using the user_id from teacher record
    const { error: updateError } = await supabase.auth.admin.updateUserById(teacher.user_id, {
