                ...
                <CardContent>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => router.push(`/parent/student/${child.id}/attendance`)}
                    >
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => router.push(`/parent/student/${child.id}/results`)}
                    >
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => router.push(`/parent/student/${child.id}/assignments`)}
                    >
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => router.push(`/parent/student/${child.id}/timetable`)}
                    >
