    ...
    <DashboardLayout role="parent">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">Pay and track billing for your children.</p>
        </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Children Billing</CardTitle>
              </CardHeader>
                ...
                {(statement?.bills || []).map((bill) => (
                  <div key={bill.id} className="border rounded-md p-3 space-y-2">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium">{bill.students?.first_name} {bill.students?.last_name} ({bill.students?.student_id})</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm">
                      <p>Total: {formatMoney(bill.total_amount)}</p>
                      <p>Paid: {formatMoney(bill.amount_paid)}</p>
                      <p>Balance: {formatMoney(bill.balance_amount)}</p>
                    </div>
