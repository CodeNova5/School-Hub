            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                <p className="text-stone-600 text-sm sm:text-base ml-13">
                  Organize and manage your question collections by subject and class
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                ...
                <StatCard icon={BookOpen} label="My Banks" value={stats.mine} accent="bg-blue-100 text-blue-700" />
        ...
        <DialogContent className="sm:max-w-md rounded-2xl">
          ...
          <div className="space-y-5 py-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-stone-500">Give your bank a clear, descriptive name</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="bank-description"
                placeholder="Add notes about this bank's content, topic, or difficulty level…"
