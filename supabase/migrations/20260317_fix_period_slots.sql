...
CREATE TABLE period_slots (
  ...
  period_number integer NOT NULL CHECK (period_number > 0 AND period_number <= 20),
  ...
  CONSTRAINT unique_school_day_period UNIQUE (school_id, day_of_week, period_number),
